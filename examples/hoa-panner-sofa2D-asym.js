////////////////////////////////////////////////////////////////////
//
//  hoa-panner-sofa2D showing an example for 2D Ambisonics usage.
//  Due to channel limitations of the Web Audio API up to 15th order
//  2D Ambisonics is possible.
//
...
var decoder = new ambisonics.binDecoder2Dasym2(context, maxOrder);
console.log(decoder);
// intensity analyser
...
limiter.out.connect(decoder.inL);
limiter.out.connect(decoder.inR);
...
var assignFiltersOnLoad = function(bufferL,bufferR) {
    console.log('successfully loaded HOA buffer:', bufferL,' & ',bufferR);
    decoder.updateFilters(bufferL,bufferR);
}
var loader_filters = new ambisonics.HRIRloader2Dasym2_local(context, maxOrder, assignFiltersOnLoad);
...
$(document).ready(function() {
    ...
    var decoderStringList = ['IRCAM Listen 1037','IRCAM Listen 1076'];
    decoderValue.innerHTML = decoderStringList[0];
    var irUrlList = [irUrl_0, irUrl_1];
    ...
    button.addEventListener('click', function() {
                          ...
                          loader_filters = new ambisonics.HRIRloader2Dasym2_local(context, maxOrder, assignFiltersOnLoad);
